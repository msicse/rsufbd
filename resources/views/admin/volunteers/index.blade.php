        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title"> <span>Volunteers</span> <a href="{{ route('admin.volunteers.create') }}" class="btn btn-success pull-right"><i class="fas fa-plus-square icon"></i>Add Volunteer</a> </h4>
                </div>
                    ...
                    <table id="myTable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('uploads/volunteers/'.$data->image ) }}"  class="img-responsive">
                                </td>
                                <td>

                                    <form  action="{{ route('admin.volunteers.status', $data->id) }}"  method="post">
                                        @csrf
                                        @if($data->status == 1)
...
<script>
    $( ".delete" ).click(function() {
            ...
            var url=location.origin+'/admin/volunteers/'+data_id;
