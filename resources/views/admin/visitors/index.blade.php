        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title"> <span>Visitors</span> <a href="{{ route('admin.visitors.create') }}" class="btn btn-success pull-right"><i class="fas fa-plus-square icon"></i>Add Visitor</a> </h4>
                </div>
                    ...
                    <table id="myTable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->name }}</td>
                                <td>{{ $data->country }}</td>
                                <td><img src="{{ asset('uploads/visitors/'. $data->image) }}" alt=""></td>
...
<script>
    $( ".delete" ).click(function() {
            ...
            var url=location.origin+'/admin/visitors/'+data_id;
