        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" data-background-color="purple">
                    <h4 class="title"> <span>Edit User</span> <a href="{{ route('admin.users.index') }}" class="btn btn-info pull-right"><i class="fas fa-backward icon"></i>Back</a> </h4>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="name" class="form-control" id="" value="{{ $user->name }}" placeholder="Name">
                                </div>
                            ...
                            <div class="col-md-12 text-center">
                                <img src="{{ asset('uploads/users/'. $user->image) }}" style="height: 100px; width: 110px;" alt="">
                            </div>
                            <div class="col-md-12 text-center">
